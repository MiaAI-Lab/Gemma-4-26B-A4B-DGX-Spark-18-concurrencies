...
class Gemma4ForCausalLM(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if config.tie_word_embeddings:
            # ModelOpt does not implement ParallelLMHead.tie_weights(), but
            # Gemma4 checkpoints omit lm_head tensors and rely on tied
            # embeddings. Share the embedding parameter directly.
